...
public class Main {
    ...
    public static void main(String[] args) {
        GameProgress game1 = new GameProgress(10, 100, 2, 100.6);
        GameProgress game2 = new GameProgress(35, 200, 4, 802.6);
        GameProgress game3 = new GameProgress(80, 300, 10, 808.5);
        ...
        arrayList.add("C://Games1//savegames//game1.dat");
        arrayList.add("C://Games1//savegames//game2.dat");
        arrayList.add("C://Games1//savegames//game3.dat");
        zipFiles("C://Games1//savegames//zip.zip", arrayList);
        File game1Dat = new File("C://Games1//savegames//game1.dat");
        File game2Dat = new File("C://Games1//savegames//game2.dat");
        File game3Dat = new File("C://Games/1/savegames//game3.dat");
